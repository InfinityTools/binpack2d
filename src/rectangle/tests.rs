...
#[test]
fn rectangle_get() {
    let rect = Rectangle::new(5, 8, Dimension::with_id(1, 6, 7));
    assert_eq!(5, rect.x());
    assert_eq!(8, rect.y());
...
#[test]
fn rectangle_set() {
    let mut rect = Rectangle::new(0, 0, Dimension::with_id(1, 3, 4));
...
fn rectangle_union() {
    ...
    assert_eq!(Rectangle::new(2, 2, Dimension::with_id(1, 7, 5)),
               r1.union(&r2, Some(1)));
    assert_eq!(Rectangle::new(2, 2, Dimension::with_id(2, 13, 13)),
               r1.union(&r3, Some(2)));
}
